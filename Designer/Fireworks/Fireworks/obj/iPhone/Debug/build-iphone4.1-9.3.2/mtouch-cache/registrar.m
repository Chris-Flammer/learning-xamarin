...
static UILabel * native_to_managed_trampoline_8 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [0];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_9 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UILabel * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
static UISwitch * native_to_managed_trampoline_10 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [0];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_11 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UISwitch * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
static UISlider * native_to_managed_trampoline_12 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [0];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_13 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UISlider * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
static UIButton * native_to_managed_trampoline_14 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [0];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_15 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIButton * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "Fireworks.AppDelegate, Fireworks", "get_Window");
	}

	-(void) setWindow:(UIWindow *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "set_Window");
	}

	-(BOOL) application:(UIApplication *)p0 didFinishLaunchingWithOptions:(NSDictionary *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "OnActivated");
	}

	-(void) applicationWillTerminate:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "Fireworks.AppDelegate, Fireworks", "WillTerminate");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "Fireworks.AppDelegate, Fireworks", ".ctor", &call_super);
		if (call_super)
			rv = [super init];
		return rv;
	}
...
@interface ViewController : UIViewController {
	...
	@property (nonatomic, assign) UILabel * nightLabel;
	@property (nonatomic, assign) UISwitch * nightSwitch;
	@property (nonatomic, assign) UILabel * sizeLabel;
	@property (nonatomic, assign) UISlider * sizeSlider;
	...
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(UILabel *) nightLabel;
	-(void) setNightLabel:(UILabel *)p0;
	-(UISwitch *) nightSwitch;
	-(void) setNightSwitch:(UISwitch *)p0;
	-(UILabel *) sizeLabel;
	-(void) setSizeLabel:(UILabel *)p0;
	-(UISlider *) sizeSlider;
	-(void) setSizeSlider:(UISlider *)p0;
	-(UIButton *) startButton;
	-(void) setStartButton:(UIButton *)p0;
	-(void) viewDidLoad;
	-(void) didReceiveMemoryWarning;
	-(void) toggleNight:(UISwitch *)p0;
	-(void) sliderChanged:(UISlider *)p0;
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "get_nightLabel");
	}

	-(void) setNightLabel:(UILabel *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "set_nightLabel");
	}

	-(UISwitch *) nightSwitch
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_10 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "get_nightSwitch");
	}

	-(void) setNightSwitch:(UISwitch *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, "UIKit.UISwitch, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "set_nightSwitch");
	}

	-(UILabel *) sizeLabel
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "get_sizeLabel");
	}

	-(void) setSizeLabel:(UILabel *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "set_sizeLabel");
	}

	-(UISlider *) sizeSlider
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_12 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "get_sizeSlider");
	}

	-(void) setSizeSlider:(UISlider *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_13 (self, _cmd, &managed_method, p0, "UIKit.UISlider, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "set_sizeSlider");
	}

	-(UIButton *) startButton
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_14 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "get_startButton");
	}

	-(void) setStartButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_15 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "set_startButton");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Fireworks.ViewController, Fireworks", "DidReceiveMemoryWarning");
	}

	-(void) toggleNight:(UISwitch *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, "UIKit.UISwitch, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "toggleNight");
	}

	-(void) sliderChanged:(UISlider *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_13 (self, _cmd, &managed_method, p0, "UIKit.UISlider, Xamarin.iOS", "Fireworks.ViewController, Fireworks", "sliderChanged");
	}
...
@implementation AboutViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Fireworks.AboutViewController, Fireworks", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Fireworks.AboutViewController, Fireworks", "DidReceiveMemoryWarning");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "Fireworks.AboutViewController, Fireworks", ".ctor", &call_super);
		if (call_super)
			rv = [super init];
		return rv;
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "Fireworks.AppDelegate, Fireworks", NULL },
		{"ViewController", "Fireworks.ViewController, Fireworks", NULL },
		{"AboutViewController", "Fireworks.AboutViewController, Fireworks", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [30].handle = objc_getClass ("UISlider");
	__xamarin_class_map [31].handle = objc_getClass ("UISwitch");
	...
	__xamarin_class_map [41].handle = [AboutViewController class];
